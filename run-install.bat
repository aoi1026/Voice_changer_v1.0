...
title michale_voice_changer Installer

echo Welcome to the michale_voice_changer Installer!
echo.
...
echo michale_voice_changer has been installed successfully!
echo To start michale_voice_changer, please run 'run-michale_voice_changer.bat'.
echo.
pause
exit /b 0
